...
Here is an exploratory visualization of the data set. It is a bar chart showing how the data distributes among 43 different label classes.


![alt text][image1]

From the image above we can see that the labels are not evenly distributed in the given dataset.
...
As a first step, I decided to convert the images to grayscale because the gray images contains enough information for the model to classify the inputs and dealing with grayscale images is easier than RGB images.

Here is an example of a traffic sign image before and after grayscaling.

![alt text][image2]

As a last step, I normalized the image data because the input data should have mean zero and equal variance. 
